...
export const STORE_MAP = {
  '롯데백화점':    ['건대스타시티점','천호점','영등포점','관악점','센텀시티점','부산본점','강남점','잠실점','노원점','청량리점','본점','인천점','광주점','울산점','포항점','광복점','구리점','대전점','동래점','미아점','일산점','기타'],
  '신세계백화점':  ['강남점','본점','마산점','센텀시티점','광주점','충청점','경기점','하남점','의정부점','기타'],
  '현대백화점':    ['더현대서울점','목동점','무역센터점','천호점','신촌점','압구정본점','판교점','대구점','울산점','충청점','기타'],
  'AK백화점':     ['평택점','수원점','분당점','원주점','홍대점','기타'],
  '갤러리아백화점': ['명품관','타임월드점','센터시티점','광교점','진주점','기타'],
  '그린푸드':     ['그린푸드','더현대서울점','현대 천호점','현대 신촌점','현대 목동점','현대 울산점','현대 대구점','현대 미아점','현대 디큐브시티','현대 킨텍스점','현대 중동점'],
  '농협_SHOP':   ['농협_SHOP'],
  '대동백화점':   ['대동백화점'],
  '특판':        ['특판'],
};
