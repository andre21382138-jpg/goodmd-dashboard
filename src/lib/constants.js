...
export const STORE_MAP = {
  ...
  '그린푸드':     ['더현대서울점','현대 천호점','현대 신촌점','현대 목동점','현대 울산점','현대 대구점','현대 미아점','현대 디큐브시티','현대 킨텍스점','현대 중동점','현대판교점'],
  '농협_SHOP':   ['남창원점'],
  '대동백화점':   ['대동백화점'],
  '특판':        ['특판_와이비팜_한용수','특판_와이비팜_김성현','특판_파마스퀘어','특판_사러가','국군복지단','영남실업','동화상사','창원지점(박경원님)','중소기업명품마루대구점','중소기업명품마루서울역점'],
};
...
export const HQ_MENUS = [
  ...
  { key: 'sales_settlement', icon: '🧮', label: '매출확인' },
  ...
  { key: 'member_mgmt', icon: '👥', label: '고객관리', sub: [
    ...
    { key: 'attend_event_stats',   icon: '📊', label: '출석 이벤트 현황' },
  ]},
